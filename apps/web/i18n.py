...
UI_TRANSLATIONS = {
    "zh": {
        ...
        "home_title": "别先看分数，先看这份简历现在能不能投",
        "home_subtitle": "上传简历和目标 JD 之后，系统会先告诉你能不能投、为什么、先补什么、面试大概率会怎么追问，而不是只给一个看起来很聪明的分数。",
        "home_metric_analysis_count": "本地分析记录",
        "home_metric_feedback_count": "已收集反馈",
        "home_metric_chinese_first": "优先服务中文求职场景",
        "home_metric_privacy_first": "隐私优先",
        "current_build": "当前版本",
        ...
        "hero_promise_1_title": "不是只给分",
        "hero_promise_1_copy": "先告诉你现在能不能投，再告诉你分数为什么是这样。",
        "hero_promise_2_title": "不是只抓关键词",
        "hero_promise_2_copy": "会把 JD 拆成要求、证据和缺口，而不是简单扫词。",
        "hero_promise_3_title": "不是只停在诊断",
        "hero_promise_3_copy": "会继续给改写建议和更像真实面试的追问。",
        ...
        "analysis_mode_deep_field_note": "深度诊断会额外做要求级证据复核与技能证明深度检查，更适合正式投递前再跑一遍。",
        "public_research_toggle_label": "补充公开资料搜索",
        "public_research_note": "会尝试搜索公开的岗位要求、面经和技能资料，用来丰富报告和面试承接；它只作为补充证据，不会直接改写确定性分数。",
        "llm_privacy_note": "大模型能力后续默认采用用户自带密钥的本地接入方式，不会要求把你的私钥或隐私简历上传到公开仓库。",
        "start_analysis": "开始分析",
        "view_history": "查看历史记录",
        "view_feedback": "查看试用反馈",
        "view_api_docs": "查看 API 文档",
        "home_get_title": "你会立刻拿到什么",
        "home_get_1_title": "先看能不能投",
        "home_get_1_copy": "不是先给一堆解释，而是先给投递判断。",
        "home_get_2_title": "再看为什么",
        "home_get_2_copy": "把 JD 必选要求、技能缺口和简历证据逐条摊开。",
        "home_get_3_title": "再看先改哪里",
        "home_get_3_copy": "会告诉你优先动作、投递前检查清单和改写方向。",
        "home_get_4_title": "最后承接面试",
        "home_get_4_copy": "不是通用题库，而是围绕当前缺口给出高概率追问。",
        "home_user_fit_title": "哪些人最适合现在用",
        "home_user_fit_1_title": "准备正式投递的人",
        "home_user_fit_1_copy": "尤其适合已经有目标 JD，想在投递前再复核一遍的人。",
        "home_user_fit_2_title": "海投但回复率低的人",
        "home_user_fit_2_copy": "适合排查 ATS、关键词和 must-have 证明为什么没立住。",
        "home_user_fit_3_title": "转岗或跨方向的人",
        "home_user_fit_3_copy": "适合判断哪些经历能迁移、哪些缺口要先补表达。",
        "home_user_fit_4_title": "拿到面试但总被追问的人",
        "home_user_fit_4_copy": "适合提前看到哪些地方最容易在面试里被质疑。",
        "home_difference_title": "它和普通 AI 简历打分器有什么不同",
        "home_difference_1_title": "证据优先",
        "home_difference_1_copy": "先跑确定性规则和证据链，再决定哪里需要模型帮助。",
        "home_difference_2_title": "按 JD 看，不按模板看",
        "home_difference_2_copy": "重点不是把简历写得更好看，而是更像目标岗位想看到的材料。",
        "home_difference_3_title": "不乱编经历",
        "home_difference_3_copy": "改写建议只会帮你重写表达，不会替你发明不真实的成就。",
        "home_difference_4_title": "诊断后还有下一步",
        "home_difference_4_copy": "结果会自然承接到改写建议和面试准备，而不是停在分数页。",
        "home_privacy_title": "隐私与接入方式",
        "home_privacy_1_title": "默认本地分析",
        "home_privacy_1_copy": "确定性诊断链本身不依赖公开仓库外的密钥也能运行。",
        "home_privacy_2_title": "大模型走用户自带密钥",
        "home_privacy_2_copy": "如果后续启用模型能力，也优先采用本地 BYOK 方式。",
        "home_privacy_3_title": "公开资料是补充层",
        "home_privacy_3_copy": "公开搜索只用来补充背景，不会直接篡改 ATS 和匹配结论。",
        "home_privacy_4_title": "默认不上传你的隐私材料",
        "home_privacy_4_copy": "真实简历、导出文件和运行时数据默认不提交到 GitHub。",
        ...
        "footer_note": "如果你愿意拿真实简历和目标 JD 来试，最有价值的反馈不是夸它好用，而是直接告诉我哪里不准、哪里没帮到你。",
    ...
    "en": {
        ...
        "lang_switch_en": "English",
        "brand": "Resume Navigator",
        "home_title": "Do not start with the score. Start with whether this resume is ready to apply.",
        "home_subtitle": "After you upload a resume and target JD, the app first tells you whether you should apply now, why, what to fix first, and what the interview is likely to challenge.",
        ...
        "home_metric_privacy_first": "Privacy first",
        ...
        "hero_promise_1_title": "Not just a score",
        "hero_promise_1_copy": "It tells the user whether the resume is ready to apply before diving into detail.",
        "hero_promise_2_title": "Not just keyword matching",
        "hero_promise_2_copy": "It breaks the JD into requirements, evidence, and gaps instead of only scanning tokens.",
        "hero_promise_3_title": "Not just diagnosis",
        "hero_promise_3_copy": "It continues into rewrite guidance and realistic interview follow-up.",
        ...
        "deep_default_badge": "Deep audit by default",
        ...
        "analysis_mode_deep_field_note": "Deep audit adds requirement-level evidence review and proof-depth checks, which is better before a real application.",
        "public_research_toggle_label": "Add public-web research",
        "public_research_note": "The app will try to gather public role expectations, interview write-ups, and skill references to enrich the report. This layer is supplemental and does not directly overwrite the deterministic score.",
        "llm_privacy_note": "Optional LLM features are planned as bring-your-own-key local integrations, so private keys and resumes do not need to enter the public repo.",
        "start_analysis": "Start analysis",
        "view_history": "View history",
        "view_feedback": "View feedback",
        "view_api_docs": "API docs",
        "home_get_title": "What you get immediately",
        "home_get_1_title": "An application call first",
        "home_get_1_copy": "The page starts by telling the user whether to apply now or fix blockers first.",
        "home_get_2_title": "Reasons, not vague claims",
        "home_get_2_copy": "It lays out JD must-haves, evidence, and visible gaps in plain language.",
        "home_get_3_title": "A clear next move",
        "home_get_3_copy": "It shows priority actions, a pre-application checklist, and rewrite direction.",
        "home_get_4_title": "Interview follow-through",
        "home_get_4_copy": "It continues into likely follow-up questions instead of stopping at the diagnosis page.",
        "home_user_fit_title": "Who should use it now",
        "home_user_fit_1_title": "People close to applying",
        "home_user_fit_1_copy": "Especially useful when the user already has a concrete JD and wants a final review before sending.",
        "home_user_fit_2_title": "People getting low reply rates",
        "home_user_fit_2_copy": "Useful for finding whether ATS, keywords, or missing proof are holding the resume back.",
        "home_user_fit_3_title": "People switching directions",
        "home_user_fit_3_copy": "Useful for figuring out which experiences transfer and which gaps need clearer framing.",
        "home_user_fit_4_title": "People who keep getting challenged in interviews",
        "home_user_fit_4_copy": "Useful for spotting which parts of the resume are still easy to question in conversation.",
        "home_difference_title": "How this differs from a generic AI resume scorer",
        "home_difference_1_title": "Evidence first",
        "home_difference_1_copy": "The app relies on deterministic rules and evidence chains before it asks a model to help.",
        "home_difference_2_title": "JD-first, not template-first",
        "home_difference_2_copy": "The goal is not a prettier resume. The goal is a resume that answers the target role better.",
        "home_difference_3_title": "No invented achievements",
        "home_difference_3_copy": "Rewrite guidance helps the user express real experience more clearly. It does not fabricate wins.",
        "home_difference_4_title": "Diagnosis leads somewhere",
        "home_difference_4_copy": "The result naturally continues into rewrite guidance and interview preparation.",
        "home_privacy_title": "Privacy and model access",
        "home_privacy_1_title": "Deterministic core works locally",
        "home_privacy_1_copy": "The rule-based diagnosis flow can already run without forcing users to configure an external model key.",
        "home_privacy_2_title": "LLMs are bring-your-own-key",
        "home_privacy_2_copy": "If model features are enabled later, local BYOK remains the preferred path.",
        "home_privacy_3_title": "Public research is supplemental",
        "home_privacy_3_copy": "Public search adds context. It does not directly rewrite the ATS or match result.",
        "home_privacy_4_title": "Private files stay private by default",
        "home_privacy_4_copy": "Real resumes, exports, and runtime files are not meant to be pushed to GitHub.",
        ...
        "footer_note": "The most valuable feedback is not praise. It is a concrete note about what still feels wrong, weak, or unhelpful in a real resume plus JD case.",
